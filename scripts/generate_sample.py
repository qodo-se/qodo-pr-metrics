...
_SPOTLIGHT_PAGINATION     = [{"title": "Pagination skips records when page size equals dataset size", "category": "requirement_gap", "sub_label": "Correctness"}]
...
ROWS = [
    ...
    _pr("repo-platform", 435, "dev-alice", f"{BASE}/repo-platform/pull/435", 95,  True,  2,2, 4,3, 2,2, 2,1, 2,2, qodo_min=5,  human_min=None, has_human=False, speed_to_fix_min=8, commits_after_qodo=1, final_approver="dev-alice"),
    ...
    _pr("repo-infra", 151, "dev-judy",  f"{BASE}/repo-infra/pull/151", 340, True,   7,6,  9,7, 4,4, 6,5, 6,4, qodo_min=8,  human_min=480, has_human=True,  spotlight=_SPOTLIGHT_RACE_CONDITION),
    _pr("repo-infra", 147, "dev-ivan",  f"{BASE}/repo-infra/pull/147", 190, True,   5,4,  6,5, 3,3, 4,3, 4,3, qodo_min=6,  human_min=None, has_human=False, spotlight=_SPOTLIGHT_NULL_DEREF),
    ...
    _pr("repo-mobile", 78, "dev-kate",  f"{BASE}/repo-mobile/pull/78", 260, True,  4,3, 5,4, 3,2, 3,3, 3,2, qodo_min=5,  human_min=220, has_human=True,  spotlight=_SPOTLIGHT_OFF_BY_ONE),
    _pr("repo-mobile", 74, "dev-frank", f"{BASE}/repo-mobile/pull/74", 180, True,  3,2, 4,3, 2,2, 2,1, 3,2, qodo_min=9,  human_min=None, has_human=False, spotlight=_SPOTLIGHT_TIMEZONE),
